...
|---|---|---|---|
| People | Outdoor thermal comfort | Site-wide exposure and how far passive cooling carries | Aim canopy and planting at the stretches that fail |
| Traffic | Energy | Renewable share, emissions, curtailment, reserve | Protect the renewable target under real demand |
| Transport | Emissions and noise | Where the load gathers and where it dissipates | Target the genuine sources, not the whole site |
| Transport | Flood and storm surge | Where water reaches habitats and how sediment moves | Plan protection and recovery around the areas that bear the load |
| Environment | Water quality | How dissolved oxygen, nutrients, turbidity, and temperature move together | Respond while a response still changes the outcome |
| Environment | Ocean current | How the basin flushes, mixes, and carries sediment | Address the mechanism behind water-quality outcomes |
| Environment | Wave | Where breaking energy concentrates and drives erosion | Protect the coast genuinely under pressure |
| Environment | Coral reef | Bleaching risk on the degree-heating-weeks scale over the horizon | Plan protection while the reef is still approaching the line |
