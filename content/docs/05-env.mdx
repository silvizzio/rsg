...
| Transport | Emissions and noise | Where the load gathers and where it dissipates across the site | Target the genuine sources, not the whole site | [Emissions and noise](/docs/10-simulation-transport#emissions-and-noise__environment-manager) |
