...
![The most urgent tier: egress has stalled at a single doorway and the queue is backing up behind it, the point where a delay turns into a crush.](04-ops-lod3-bim-2-human-evacuation-bottleneck-alert.jpg)
...
![A stairwell approaching its descent limit as two floors' flow merges, the squeeze to relieve before it stalls.](04-ops-lod3-bim-2-human-evacuation-bottleneck-critical.jpg)
...
![The earliest signal: density climbing in a corridor while flow still moves, caught with room to act.](04-ops-lod3-bim-2-human-evacuation-bottleneck-warning.jpg)
...
| People | Evacuation | Clearance time and the binding exit | Act on the exit or route that drives the number | [Evacuation](/docs/08-simulation-people#evacuation__operations-manager) |
| Traffic | Mobility | The day's load against fleet and charging | Rebalance before the peak, naming the binding constraint | [Mobility](/docs/09-simulation-traffic#mobility__operations-manager) |
| Traffic | Energy | Clean share against the backup trigger and reserve | Shape dispatch and reserve before the gap compounds | [Energy](/docs/09-simulation-traffic#energy__operations-manager) |
| Traffic | Shuttle network | Utilization and the legs running hot | Add or rebalance service before a leg saturates | [Shuttle network](/docs/09-simulation-traffic#shuttle-network__operations-manager) |
...
| Transport | Safety conflicts | Which crossings flare up under load | Focus staffing and control where risk concentrates | [Safety conflicts](/docs/10-simulation-transport#safety-conflicts__operations-manager) |
| Transport | Flood and storm surge | Surge reach and depth at critical facilities | Secure and clear before the surge lands | [Flood and storm surge](/docs/10-simulation-transport#flood-and-storm-surge__operations-manager) |
...
![Mobility, Operations read.](04-ops-lod3-simulation-traffic-mobility.jpg)
...
![Shuttle network, Operations read.](04-ops-lod3-simulation-traffic-shuttle-network.jpg)
...
![Drop-off forecourt, Operations read.](04-ops-lod3-simulation-traffic-drop-off-forecourt.jpg)
...
![Safety conflicts, Operations read.](04-ops-lod3-simulation-transport-safety.jpg)
...
![Flood and storm surge, Operations read.](04-ops-lod3-simulation-transport-flood-and-storm-surge.jpg)
